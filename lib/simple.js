...
END:VCARD
    ...
    /**
    * Envía un mensaje de lista
    * @param jid el id al que se enviará
    * @param button el texto opcional del botón, título y descripción del botón
    * @param rows las filas de la lista de secciones del mensaje
    */
    sendListM: {
...
let canalNombre = ["𝗔𝗡𝗢𝗧𝗛𝗘𝗥 𝗖𝗛𝗔𝗡𝗡𝗘𝗟 ⟡ 𝐂𝐨𝐫𝐢𝐧𝐏𝐥𝐮𝐬 💫", "TK - UPDATE 💻", "Tips sobre Admin-TK 🤩", "𝐏𝐫𝐨𝐲𝐞𝐜𝐭𝐨 𝐀𝐜𝐭𝐮𝐚𝐥 ⟡ 𝑨𝒅𝒎𝒊𝒏-𝑻𝑲 ✨"]
...
export function serialize() {
    ...
    const existingDescriptor = Object.getOwnPropertyDescriptor(proto.WebMessageInfo.prototype, 'id');
    if (!existingDescriptor || existingDescriptor.configurable) {
        Object.defineProperty(proto.WebMessageInfo.prototype, 'id', {
            get() {
                return this.key?.id;
            },
            enumerable: true,
