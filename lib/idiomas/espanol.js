...
const smsWelcome = () => {
    return `
🎉 ¡Hey @⁨user⁩, ya era hora que llegaras! 🎉

『Prepárate para el chisme en *@subject* 😜』

Soy Admin-TK del grupo, ¡y te doy la bienvenida comparte memes y chisme! 😂

_*Pero antes...*_*presentate*_ con nombre, edad, y la mejor foto que tengas, ¡queremos saber a quién vamos a trolear! 📸

*Así que relájate, disfruta y deja que empiece la diversión! 🥳*
`;
}
