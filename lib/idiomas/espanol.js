...
const smsWelcome = () => {
    return `
🎉 ¡Hey @⁨user ⁩, que onda perdid@! 🎉

『Prepárate para el chisme en *@subject* 😜』

Soy Admin-TK del grupo, ¡y te doy la bienvenida! 😂

_*presentate*_ con nombre, edad, y la mejor foto que tengas 📸

*Evita un ban, leeas reglas! 🥳*
`;
}
